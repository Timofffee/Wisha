...
var base_tokens = {
    ...
    "title" : funcref(self, "TOKEN_TITLE"),

    "env" : funcref(self, "TOKEN_ENV"),
    "hide" : funcref(self, "TOKEN_HIDE"),
...
func TOKEN_TITLE(line: String) -> Dictionary:
    return {"type" : Token.TITLE, "name" : line}

func TOKEN_ENV(line: String) -> Dictionary:
    return {"type" : Token.ENV, "name" : line}

func TOKEN_HIDE(line: String) -> Dictionary:
    return {"type" : Token.HIDE, "name" : line}
